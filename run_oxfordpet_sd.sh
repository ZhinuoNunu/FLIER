MODEL=CLIP_B16
OUTPUT_DIR=./output_oxfordpet
DATA_PATH=/home/prp2/zzn/data/oxford_pets
DATASETNAME=oxford_pets
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0,2,1,3 python -m torch.distributed.launch --nproc_per_node=2 run_class_finetuning.py \
    --cache_path "/home/prp2/zzn/stable_diffusion/stablediffusion/outputs/cache_features/sd_samples_oxfordpets.pt" \
    --dict_path "/home/prp2/zzn/clip/SD-CLIP/data/oxfordpets.json" \
