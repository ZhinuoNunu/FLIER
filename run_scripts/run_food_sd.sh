MODEL=CLIP_B16
OUTPUT_DIR=./outputs_food
DATA_PATH=/home/prp2/zzn/data/food101
DATASETNAME=food101
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0,2,1,3 python -m torch.distributed.launch --nproc_per_node=2 run_class_finetuning.py \
    --dict_path "/home/prp2/zzn/clip/FS-SD-CLIP/data/food101.json" \
    --cache_path "/home/prp2/zzn/stable_diffusion/stablediffusion/outputs_food/cache_features/sd_samples_food.pt" \
