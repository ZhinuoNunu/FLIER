...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=2 run_class_finetuning_nosd.py \
    --dict_path "/home/prp2/zzn/clip/SD-CLIP/data/caltech101.json" \
    --is_fewshot \
    --shot 1 \
